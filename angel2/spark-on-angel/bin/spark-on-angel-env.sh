...
#export SPARK_HOME=/home/workspace/spark-2.4.0-bin-hadoop2.7
#export ANGEL_HOME=/opt/module/angel-1.4.0-bin
export ANGEL_HOME=/data/angel2/dist/target/angel-1.4.0-bin
#export ANGEL_HOME=/home/shu_wanggz/wgz/angel-1.4.0-bin
export ANGEL_HDFS_HOME=hdfs://node0:9820/user/lzz/angel-1.4.0-bin
#export ANGEL_HDFS_HOME=hdfs://hcdsj/user/shu_wanggz/lzz/angel-1.4.0-bin
